<section class="space-y-6">
    ...
    <form method="post" action="{{ route('profile.update') }}" class="space-y-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2">
                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Full Legal
                    Name</label>
            ...
            <div class="space-y-2">
                <label class="block text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">Institutional
                    Email</label>
                    ...
                    <div class="mt-4">
                        <p class="text-xs font-bold text-amber-600 dark:text-amber-400 uppercase tracking-tighter italic">
                            ...
                            <button form="send-verification"
                                class="ml-2 underline text-[10px] font-black uppercase text-gray-400 hover:text-indigo-600 transition-colors">
