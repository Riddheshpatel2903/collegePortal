    ...
    <div class="flex h-full flex-col">
        ...
        <div class="flex items-center gap-3 border-b border-white/10 px-6 py-5">
            <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
                <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-500 flex items-center justify-center shadow-lg shadow-violet-500/30 group-hover:scale-110 transition-transform duration-300">
                    <i class="bi bi-mortarboard-fill text-white text-lg"></i>
                </div>
                <div>
                    <h2 class="text-sm font-black tracking-widest uppercase text-white/90 group-hover:text-white transition-colors">EDU<span class="text-violet-400">PORTAL</span></h2>
                    <p class="text-[9px] font-bold text-violet-400/50 uppercase tracking-widest leading-none">Management</p>
                </div>
            </a>
        </div>
        ...
        <nav class="flex-1 px-4 py-6 overflow-y-auto space-y-1 custom-scrollbar">
            @auth
                ...
                @if($role == 'admin')
                    ...
                    <p class="px-4 mt-5 mb-3 text-[10px] font-bold text-violet-400/50 uppercase tracking-[0.2em]">Finance & Info</p>
