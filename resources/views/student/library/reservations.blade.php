...
@section('header_title', 'Library Reservations')

@section('content')
    <div class="space-y-6">
        <div>
            <h2 class="text-2xl font-black text-slate-900">Reservations</h2>
            <p class="text-sm text-slate-500">Your reservation queue and status.</p>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    @forelse($reservations as $reservation)
                        <tr>
                            <td class="px-4 py-3 font-semibold">Book #{{ $reservation->library_book_id }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-6 text-center text-slate-400">No reservations found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
