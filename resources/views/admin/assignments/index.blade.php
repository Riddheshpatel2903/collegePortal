                                    ...
                                    <td>
                                        <div class="flex flex-col">
                                            ...
                                            <span class="text-[10px] text-slate-400 font-bold uppercase tracking-tight mt-0.5">
                                                By Prof. {{ $assignment->teacher?->user?->name ?? 'Unassigned' }}
                                            </span>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="flex flex-col">
                                            <span
                                                class="text-[10px] font-black text-violet-600 uppercase">{{ $assignment->subject?->name ?? 'No Subject' }}</span>
                                            <span class="text-[9px] text-slate-400 font-bold">{{ $assignment->course?->name ?? 'No Course' }} -
                                                {{ $assignment->semester?->name ?? 'No Semester' }}</span>
                                        </div>
                                    </td>
