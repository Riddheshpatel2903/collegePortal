@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:gap-4 sm:items-center sm:justify-between min-w-0">
            ...
            <div class="overflow-x-auto max-w-full pb-2 custom-scrollbar flex-1 flex justify-end">
